...
def SBI( str_name , b_only_download ,dict_config, getLibrary ):
    ...
    if(dict_config['arch']=="unix"):
        ...
        STR_CFG += " -DGEOTIFF_LIBRARY_DEBUG='" + install_dir + "/lib/libgeotiffd.so'"    
        ...
        STR_CFG += " -DGEOS_LIBRARY_DEBUG='" + install_dir + "/lib/libgeos_c.so'"
        
        STR_CFG += ' -DSQLITE3_INCLUDE_DIR="' + install_dir + '"/include'
        STR_CFG += " -DSQLITE3_LIBRARY='" + install_dir + "/lib/libsqlite.so'"
        STR_CFG += " -DSQLITE3_LIBRARY_DEBUG='" + install_dir + "/lib/libsqlited.so'"
