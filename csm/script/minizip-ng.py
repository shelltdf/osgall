...
def SBI( str_name , b_only_download ,dict_config, getLibrary ):
    ...
    # STR_CFG += ' -DBZIP2_LIBRARY=' + install_dir + '/lib/zlib.lib'
    # STR_CFG += ' -DBZIP2_LIBRARY_DEBUG=' + install_dir + '/lib/zlibd.lib'
        
    source_dir = os.getcwd() + '/../prebuild/minizip-ng-master'
